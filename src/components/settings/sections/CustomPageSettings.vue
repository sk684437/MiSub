...
const navTemplate = [
  ...
  '</head>',
  '<body>',
  '<div class="page"><div class="theme-switcher">{{theme_toggle}}</div><div class="wrapper"><h1>Start</h1><div class="subtitle">A calm place to begin</div><div class="search"><input id="search" placeholder="Search or type URL" autocomplete="off" /></div><div class="grid"><a class="card" href="https://github.com" target="_blank" rel="noreferrer"><div class="icon"><img src="https://www.google.com/s2/favicons?sz=64&domain=github.com" alt="GitHub"></div><div class="name">GitHub</div></a><a class="card" href="https://twitter.com" target="_blank" rel="noreferrer"><div class="icon"><img src="https://www.google.com/s2/favicons?sz=64&domain=twitter.com" alt="X"></div><div class="name">X</div></a><a class="card" href="https://youtube.com" target="_blank" rel="noreferrer"><div class="icon"><img src="https://www.google.com/s2/favicons?sz=64&domain=youtube.com" alt="YouTube"></div><div class="name">YouTube</div></a><a class="card" href="https://openai.com" target="_blank" rel="noreferrer"><div class="icon"><img src="https://www.google.com/s2/favicons?sz=64&domain=openai.com" alt="OpenAI"></div><div class="name">OpenAI</div></a></div><div class="footer">Designed with space, rhythm, and calm</div></div></div>',
  '<scr' + 'ipt>',
