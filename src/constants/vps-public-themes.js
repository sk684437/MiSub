export const VPS_PUBLIC_THEME_PRESETS = {
  default: {
    ...
    heroBadge: 'border-[#e6ded2] bg-white/85 text-[#7b6e5f] dark:border-slate-700/60 dark:bg-slate-900/70 dark:text-slate-300',
  ...
  komari: {
    ...
    heroBadge: 'border-sky-100 bg-white/92 text-sky-700 dark:border-sky-900/40 dark:bg-sky-900/35 dark:text-sky-300',
  ...
  minimal: {
    ...
    layout: 'minimal',
    root: 'text-slate-900 dark:text-slate-100',
    heroBadge: 'border-slate-200 bg-white/80 text-slate-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400',
    heroTitle: 'text-slate-900 dark:text-slate-100',
  ...
  tech: {
    ...
    layout: 'tech-grid',
    root: 'text-slate-900 dark:text-slate-100',
    heroBadge: 'border-cyan-200 bg-cyan-50 text-cyan-700 dark:border-cyan-500/20 dark:bg-cyan-500/12 dark:text-cyan-300',
  ...
  glass: {
    ...
    root: 'text-slate-900 dark:text-slate-100',
    heroBadge: 'border-white/40 bg-white/32 text-slate-700 backdrop-blur-xl dark:border-white/10 dark:bg-white/6 dark:text-slate-300 dark:backdrop-blur-xl',
    heroTitle: 'text-slate-900 dark:text-slate-100',
    heroText: 'text-slate-600 dark:text-slate-400',
