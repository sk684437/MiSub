export const VPS_PUBLIC_THEME_PRESETS = {
  ...
  komari: {
    ...
    label: 'Komari 风',
    layout: 'hero-split',
    root: 'bg-[#f4f7fb] text-slate-900 dark:bg-[#0f172a] dark:text-slate-100',
    ...
    statCard: 'border-sky-100/90 bg-white/92 shadow-[0_20px_42px_-28px_rgba(14,165,233,0.32)] dark:border-sky-900/40 dark:bg-sky-900/30 dark:shadow-[0_20px_42px_-28px_rgba(14,165,233,0.15)]',
    panel: 'border-sky-100/90 bg-white/92 shadow-[0_22px_60px_-40px_rgba(15,23,42,0.16)] dark:border-sky-900/40 dark:bg-sky-900/30 dark:shadow-[0_22px_60px_-40px_rgba(14,165,233,0.15)]',
    panelSoft: 'border-sky-100/90 bg-gradient-to-br from-white via-sky-50/75 to-indigo-50/70 dark:border-sky-900/40 dark:bg-gradient-to-br from-sky-900/40 via-sky-800/30 to-indigo-900/30',
  ...
  minimal: {
    ...
    label: '极简',
    layout: 'minimal',
    root: 'bg-white text-slate-900 dark:bg-[#1a1a1a] dark:text-slate-100',
    ...
    statCard: 'border-slate-200 bg-white shadow-none dark:border-slate-700 dark:bg-slate-800 dark:shadow-none',
    panel: 'border-slate-200 bg-white shadow-none dark:border-slate-700 dark:bg-slate-800 dark:shadow-none',
    panelSoft: 'border-slate-200 bg-white shadow-none dark:border-slate-700 dark:bg-slate-800 dark:shadow-none',
  ...
  tech: {
    ...
    label: '科技',
    layout: 'tech-grid',
    root: 'bg-[#f8fafc] text-slate-900 dark:bg-[#050816] dark:text-slate-100',
    ...
    heroText: 'text-slate-600 dark:text-slate-400',
    statCard: 'border-cyan-200/80 bg-white/90 shadow-[0_22px_52px_-34px_rgba(6,182,212,0.28)] dark:border-cyan-400/20 dark:bg-[#0b1226]/96 dark:shadow-[0_22px_52px_-34px_rgba(6,182,212,0.28)]',
    panel: 'border-cyan-200/80 bg-white/90 shadow-[0_28px_65px_-36px_rgba(6,182,212,0.24)] dark:border-cyan-400/20 dark:bg-[#0b1226]/94 dark:shadow-[0_28px_65px_-36px_rgba(6,182,212,0.24)]',
    panelSoft: 'border-cyan-200/80 bg-gradient-to-br from-white via-cyan-50/75 to-blue-50/70 dark:border-cyan-400/20 dark:bg-gradient-to-br from-[#091122] via-[#0d1730] to-[#122044]',
  ...
  glass: {
    ...
    root: 'bg-[#eef4ff] text-slate-900 dark:bg-[#0f172a] dark:text-slate-100',
    ...
    heroTitle: 'text-slate-900 dark:text-slate-100',
    heroText: 'text-slate-600 dark:text-slate-400',
    statCard: 'border-white/34 bg-white/38 backdrop-blur-2xl shadow-[0_20px_46px_-30px_rgba(99,102,241,0.24)] dark:border-white/10 dark:bg-white/5 dark:backdrop-blur-2xl dark:shadow-[0_20px_46px_-30px_rgba(99,102,241,0.12)]',
    panel: 'border-white/34 bg-white/38 backdrop-blur-2xl shadow-[0_24px_68px_-40px_rgba(99,102,241,0.24)] dark:border-white/10 dark:bg-white/5 dark:backdrop-blur-2xl dark:shadow-[0_24px_68px_-40px_rgba(99,102,241,0.12)]',
